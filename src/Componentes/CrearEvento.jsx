  ...
  function CrearEvento() {
    ...
    const handleSubmit = (ev) => {
      ...
      if (verificacion){
        const newEvento = {Id:"NUll", IdSocio:cedula, NombreE:nombreEv, NombreD:nombreEm, NombreC:nombreC, telefonoC:telC, Fecha:fecha, Hora:hora, Tipodemontaje:tipoMontaje, NumeroP:numeroP, Alimentacion:tipoAlimentacion, Notas:descripcon};
        for (var daticos in 
          newEvento){
          console.log(
            newEvento[daticos]);
